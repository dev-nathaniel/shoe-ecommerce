export const slides = {
  Nike: [
    {
      id: 1,
      img: require("../assets/images/air-max-furyosa.png"),
      name: "Nike Air Max Furyosa",
      category: "Women's shoe",
      price: 144.95,
      backgroundColor: "#f5b92d",
      description:
    ...
    {
      id: 2,
      img: require("../assets/images/air-huarache.png"),
      name: "Nike Air Huarache",
      category: "Women's shoe",
      backgroundColor: "#eea1a3",
      price: 80.47,
      description:
        "This version of the Nike Air Huarache runs it back with soft colours ready for spring. The iconic heel clip and stripped-away branding return to keep the early-90s look you love. Suede overlays and a soft foam midsole add comfort and structure.",
    },
    {
      id: 3,
      img: require("../assets/images/air-max-tw.png"),
      name: "Nike Air Max TW",
      category: "Men's shoe",
      backgroundColor: "#8372f5",
      price: 144.95,
      description:
    ...
    {
      id: 4,
      img: require("../assets/images/zoom-fly-5.png"),
      name: "Nike Zoom Fly 5",
      category: "Men's shoe",
      backgroundColor: "#ff6e0270",
      price: 144.95,
      description:
    ...
    {
      id: 5,
      img: require("../assets/images/pegasus.png"),
      name: "Nike Pegasus 39",
      category: "Men's shoe",
      backgroundColor: "#f4002d70",
      price: 109.95,
      description:
    ...
    {
      id: 6,
      img: require("../assets/images/pegasus-trail-4-gore-tex.png"),
      name: "Nike Pegasus Trail 4 Gore Tex",
      category: "Women's shoe",
      backgroundColor: "#b59da4",
      price: 144.95,
      description:
        "The Nike Pegasus Trail 4 GORE-TEX is made for those moments when you don't want to turn back, no matter what. Feel confident even in the most unforeseen weather conditions with waterproof GORE-TEX keeping you dry, so you can run for longer and take your wet run from the road to the trail without breaking stride. A waterproof layer paired with a higher ankle gaiter gives you extra coverage so you stay dry.",
    },
  ],
  Adidas: [
    {
      id: 1,
      img: require("../assets/images/adidas-adizero-sl-running-shoes.png"),
      name: "Adidas Adizero SL Running Shoes",
      category: "Women's shoe",
      price: 144.95,
      backgroundColor: "#c5163390",
      description:
        "With an edgy look inspired by the fast-paced running shoes of the '90s, the Nike Air Max Furyosa brings a bold, new voice to fashion and comfort.Offset, stacked Air in the heel delivers a big statement in cushioning.The ultra-plush heel pillow, padded collar and pillowed tongue make you feel like you've just stepped into your favourite slippers.And if that's not enough, the dual-lace system lets you be as expressive as you want, adding DIY flair to the 5-star comfort.",
    },
    {
      id: 2,
      img: require("../assets/images/gazelle.png"),
      name: "Adidas Gazelle",
      category: "Women's shoe",
      backgroundColor: "#781f2c90",
      price: 80.47,
      description:
        "This version of the Nike Air Huarache runs it back with soft colours ready for spring. The iconic heel clip and stripped-away branding return to keep the early-90s look you love. Suede overlays and a soft foam midsole add comfort and structure.",
    },
    {
      id: 3,
      img: require("../assets/images/jeans-shoes.png"),
      name: "Adidas Jeans Shoes",
      category: "Women's shoe",
      backgroundColor: "#6caf4690",
      price: 144.95,
      description:
        "So you're in love with the classic look of the '90s, but you've got a thing for today's fast-paced culture. Meet the Air Max TW. Inspired by the treasured franchise that brought Nike Air cushioning to the world and laid the foundation for the track-to-street aesthetic, its eye-catching design delivers a 1–2 punch of comfort and fashion. Ready to highlight any 'fit, its lightweight upper pairs angular and organic lines to create an entrancing haptic effect. The contrasting colourways make it easy to style. And if you're ready for the next step, the 5 windows underfoot deliver a modern edge to visible Air cushioning.",
    },
    {
      id: 4,
      img: require("../assets/images/racer-tr21.png"),
      name: "Adidas Racer TR21",
      category: "Men's shoe",
      backgroundColor: "#27427190",
      price: 144.95,
      description:
        "Bridge the gap between your weekend training run and race day in a durable design that can be deployed not just at the starting line of your favourite race but in the days and months after your conquest. It offers comfort and reliability but with a propulsive sensation that'll help you feel fast and fresh. That kind of versatility is uncommon in the running arena. But who said you can't have it all?",
    },
    {
      id: 5,
      img: require("../assets/images/ozelia-shoes.png"),
      name: "Adidas Ozelia",
      category: "Men's shoe",
      backgroundColor: "#eb7b2390",
      price: 109.95,
      description:
        "Let the Nike Pegasus 39 help you ascend to new heights. More lightweight up top than the Pegasus 38 and ideal to wear in any season, it has a supportive sensation to help keep your feet contained, while underfoot cushioning and double Zoom Air units (1 more than the Peg 38) give you an extra pop to your step. Your trusted workhorse with wings is back. Time to fly.",
    },
    {
      id: 6,
      img: require("../assets/images/nmd_r1.png"),
      name: "Adidas NMD_R1",
      category: "Women's shoe",
      backgroundColor: "#d33a4290",
      price: 144.95,
      description:
        "The Nike Pegasus Trail 4 GORE-TEX is made for those moments when you don't want to turn back, no matter what. Feel confident even in the most unforeseen weather conditions with waterproof GORE-TEX keeping you dry, so you can run for longer and take your wet run from the road to the trail without breaking stride. A waterproof layer paired with a higher ankle gaiter gives you extra coverage so you stay dry.",
    },
  ...
  Converse: [
    {
      id: 1,
      img: require("../assets/images/run-star-hike-platform-men.png"),
      name: "Run Star Hike Platform White",
      category: "Men's shoe",
      price: 144.95,
      backgroundColor: "#cdcad1",
      description:
        "With an edgy look inspired by the fast-paced running shoes of the '90s, the Nike Air Max Furyosa brings a bold, new voice to fashion and comfort.Offset, stacked Air in the heel delivers a big statement in cushioning.The ultra-plush heel pillow, padded collar and pillowed tongue make you feel like you've just stepped into your favourite slippers.And if that's not enough, the dual-lace system lets you be as expressive as you want, adding DIY flair to the 5-star comfort.",
    },
    {
      id: 2,
      img: require("../assets/images/run-star-hike-platform-men-2.png"),
      name: "Run Star Hike Platform Black",
      category: "Men's shoe",
      backgroundColor: "#07080a90",
      price: 80.47,
      description:
        "This version of the Nike Air Huarache runs it back with soft colours ready for spring. The iconic heel clip and stripped-away branding return to keep the early-90s look you love. Suede overlays and a soft foam midsole add comfort and structure.",
    },
    {
      id: 3,
      img: require("../assets/images/run-star-hike-platform-animalier.png"),
      name: "Run Star Hike Platform Animalier",
      category: "Men's shoe",
      backgroundColor: "#29282450",
      price: 144.95,
      description:
        "So you're in love with the classic look of the '90s, but you've got a thing for today's fast-paced culture. Meet the Air Max TW. Inspired by the treasured franchise that brought Nike Air cushioning to the world and laid the foundation for the track-to-street aesthetic, its eye-catching design delivers a 1–2 punch of comfort and fashion. Ready to highlight any 'fit, its lightweight upper pairs angular and organic lines to create an entrancing haptic effect. The contrasting colourways make it easy to style. And if you're ready for the next step, the 5 windows underfoot deliver a modern edge to visible Air cushioning.",
    },
    {
      id: 4,
      img: require("../assets/images/chuck-70-plus-men.png"),
      name: "Chuck 70 Plus",
      category: "Men's shoe",
      backgroundColor: "#e0ce84",
      price: 144.95,
      description:
        "Bridge the gap between your weekend training run and race day in a durable design that can be deployed not just at the starting line of your favourite race but in the days and months after your conquest. It offers comfort and reliability but with a propulsive sensation that'll help you feel fast and fresh. That kind of versatility is uncommon in the running arena. But who said you can't have it all?",
    },
    {
      id: 5,
      img: require("../assets/images/chuck-taylor-all-star-lift-platform-embroided-roses-women.png"),
      name: "Chuck Taylor All Star Lift Platform Embroided Roses",
      category: "Women's shoe",
      backgroundColor: "#dac3a9",
      price: 109.95,
      description:
        "Let the Nike Pegasus 39 help you ascend to new heights. More lightweight up top than the Pegasus 38 and ideal to wear in any season, it has a supportive sensation to help keep your feet contained, while underfoot cushioning and double Zoom Air units (1 more than the Peg 38) give you an extra pop to your step. Your trusted workhorse with wings is back. Time to fly.",
    },
    {
      id: 6,
      img: require("../assets/images/chuck-taylor-all-star-move-platform-sherpa-women.png"),
      name: "Chuck Taylor All Star Move Platform Sherpa",
      category: "Women's shoe",
      backgroundColor: "#b2896f",
      price: 144.95,
      description:
        "The Nike Pegasus Trail 4 GORE-TEX is made for those moments when you don't want to turn back, no matter what. Feel confident even in the most unforeseen weather conditions with waterproof GORE-TEX keeping you dry, so you can run for longer and take your wet run from the road to the trail without breaking stride. A waterproof layer paired with a higher ankle gaiter gives you extra coverage so you stay dry.",
    },
  ...
  Vans: [
    {
      id: 1,
      img: require("../assets/images/old-skool-tapered-women.png"),
      name: "Vans Old Skool Tapered",
      category: "Women's shoe",
      price: 144.95,
      backgroundColor: "#664a3690",
      description:
        "With an edgy look inspired by the fast-paced running shoes of the '90s, the Nike Air Max Furyosa brings a bold, new voice to fashion and comfort.Offset, stacked Air in the heel delivers a big statement in cushioning.The ultra-plush heel pillow, padded collar and pillowed tongue make you feel like you've just stepped into your favourite slippers.And if that's not enough, the dual-lace system lets you be as expressive as you want, adding DIY flair to the 5-star comfort.",
    },
    {
      id: 2,
      img: require("../assets/images/old-skool-overt-cc.png"),
      name: "Vans Old Skool Overt CC",
      category: "Women's shoe",
      backgroundColor: "#eea1a3",
      price: 80.47,
      description:
    ...
    {
      id: 3,
      img: require("../assets/images/old-skool-men.png"),
      name: "Vans Old Skool",
      category: "Men's shoe",
      backgroundColor: "#4c6e8b90",
      price: 144.95,
      description:
        "So you're in love with the classic look of the '90s, but you've got a thing for today's fast-paced culture. Meet the Air Max TW. Inspired by the treasured franchise that brought Nike Air cushioning to the world and laid the foundation for the track-to-street aesthetic, its eye-catching design delivers a 1–2 punch of comfort and fashion. Ready to highlight any 'fit, its lightweight upper pairs angular and organic lines to create an entrancing haptic effect. The contrasting colourways make it easy to style. And if you're ready for the next step, the 5 windows underfoot deliver a modern edge to visible Air cushioning.",
    },
    {
      id: 4,
      img: require("../assets/images/style-53-cozy-mule-dx-women.png"),
      name: "Vans Style 53 Cozy Mule Dx",
      category: "Men's shoe",
      backgroundColor: "#18161490",
      price: 144.95,
      description:
        "Bridge the gap between your weekend training run and race day in a durable design that can be deployed not just at the starting line of your favourite race but in the days and months after your conquest. It offers comfort and reliability but with a propulsive sensation that'll help you feel fast and fresh. That kind of versatility is uncommon in the running arena. But who said you can't have it all?",
    },
    {
      id: 5,
      img: require("../assets/images/flame-old-skool.png"),
      name: "Vans Flame Old Skool",
      category: "Men's shoe",
      backgroundColor: "#d03a3495",
      price: 109.95,
      description:
        "Let the Nike Pegasus 39 help you ascend to new heights. More lightweight up top than the Pegasus 38 and ideal to wear in any season, it has a supportive sensation to help keep your feet contained, while underfoot cushioning and double Zoom Air units (1 more than the Peg 38) give you an extra pop to your step. Your trusted workhorse with wings is back. Time to fly.",
    },
    {
      id: 6,
      img: require("../assets/images/checkerboard-classic-slip-on-men.png"),
...
export const countryListAllIsoData = [
  ...
  {
    title: "O",
    data: [{ code: "OM", code3: "OMN", name: "Oman", number: "512" }],
  },
  {
    title: "P",
    data: [
  ...
  {
    title: "Q",
    data: [{ code: "QA", code3: "QAT", name: "Qatar", number: "634" }],
  },
  {
    title: "R",
    data: [
  ...
  {
    title: "Y",
    data: [{ code: "YE", code3: "YEM", name: "Yemen", number: "887" }],
  },
  {
    title: "Z",
    data: [
  ...
  {
    title: "Å",
    data: [{ code: "AX", code3: "ALA", name: "Åland Islands", number: "248" }],
  },
];
